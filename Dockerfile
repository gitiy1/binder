FROM debian:11
RUN apt update
RUN DEBIAN_FRONTEND=noninteractive apt install ssh git unzip gcc git make wget neovim fish tmux byobu curl python3 neofetch sudo nano netcat openssl socat python3-pip qemu libvirt-daemon-system-sysv virtinst libguestfs-tools bridge-utils -y
